...
// =============================================================================
// WeekView — Week-Ahead OT Calendar (originally /ot-calendar/page.tsx)
//
// REHOUSED in OT.4 (28 Apr 2026): /ot-calendar's 807-LOC body extracted
// into this component so the OT Management Module's Week section can render
// it inline. The standalone /ot-calendar route is now a 308 redirect to
// /ot-management?tab=week.
//
// Original spec — Week-Ahead OT Calendar (26 Apr 2026 redesign):
//
