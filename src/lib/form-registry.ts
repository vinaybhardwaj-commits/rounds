...
export const FINANCIAL_COUNSELING: FormSchema = {
  ...
  description: 'Capture financial discussion, insurance details, room rent eligibility, and patient consent before admission.',
  version: 2,
  stages: ['pre_admission', 'admitted'],
  ...
  sections: [
    ...
    },
    {
      ...
      fields: [
        ...
        ], visibleWhen: { field: 'payment_mode', operator: 'eq', value: 'insurance' }, width: 'half',
          helpText: 'Select "Direct" if hospital deals with insurer directly without TPA' },
        { key: 'insurance_provider', label: 'Insurance Company', type: 'text', placeholder: 'E.g. Bajaj General, Star Health, HDFC Ergo',
          visibleWhen: { field: 'payment_mode', operator: 'eq', value: 'insurance' }, width: 'half', validation: { required: true } },
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'preauth_initiated', label: 'Insurance pre-authorization initiated', type: 'checkbox',
          ...
          visibleWhen: { field: 'payment_mode', operator: 'eq', value: 'insurance' } },
        { key: 'counseling_notes', label: 'Counseling Notes', type: 'textarea', placeholder: 'Any special payment arrangements, exemptions, discounts, room rent waivers, etc.' },
      ],
    },
  ],
};
